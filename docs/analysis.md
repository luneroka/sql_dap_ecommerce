...
The analysis of Q2 performance reveals a high-volume ecommerce business with a broad product catalog and a strong reliance on a narrow set of product categories. While revenue is concentrated, demand remains dynamic and operational factors play a key role in overall performance.

---

### 6.2. Key Insights

#### 1. Revenue is highly concentrated in a single product family

- Nearly 80% of total revenue is generated by the top 3 categories: **Kurta, Kurta Set, and Set**
- These categories represent variations of the same product type, indicating a strong dependency on the **Kurta product family**
- The rest of the catalog contributes marginally despite its size

-> The business is structurally dependent on a narrow product segment

---

#### 2. Growth is driven by volume, not pricing or basket size

- Sales increased sharply at the end of April (+45%) before declining steadily through May and June
- Average Order Value remained stable (~$8.7–$9.7) throughout the period

-> Revenue fluctuations are primarily driven by **order volume**, not pricing strategy or customer spend

---

#### 3. The catalog follows a classic long-tail distribution

- ~27% of products generate 80% of total revenue
- 98.36% of products individually contribute less than 0.1% of revenue

-> The catalog is **extremely fragmented**, with a vast majority of SKUs having negligible individual impact

---

#### 4. Top-performing products are highly unstable over time

- Only 6 out of the Top 20 products are retained from April to May
- 11 out of 20 are retained from May to June
- Monthly churn in Top 20 ranges from 45% to 100%

-> Revenue is concentrated, but **not in consistently dominant products**
-> Demand shifts rapidly across SKUs, indicating a highly competitive and interchangeable product landscape

---

#### 5. Fulfillment method does not impact revenue, but affects reliability

- Amazon and Merchant fulfillment show identical revenue and volume distribution (~71% vs 29%)
- Average Order Value is similar across both methods (~$9)

-> Fulfillment type does **not influence revenue generation**

However:

- Merchant orders have a **36% higher cancellation rate** (17.54% vs 12.87%)

-> Fulfillment impacts **operational performance**, not sales

---

#### 6. Cancellations represent a significant revenue loss

- Cancelled orders account for **$90,952**, or **8.81% of total revenue**
- Amazon fulfillment contributes more to total lost revenue due to higher volume
- Merchant fulfillment has a higher relative cancellation risk

-> Revenue loss is driven by a combination of **volume (Amazon)** and **higher failure rate (Merchant)**

---

### 6.3. Final Takeaways

- The business is heavily reliant on a **single product family**, creating concentration risk
- Revenue performance is **volume-driven**, with no evidence of pricing leverage
- The product catalog is **large but inefficient**, dominated by a long tail of low-performing SKUs
- Demand is **highly dynamic**, with frequent rotation among top-selling products
- Fulfillment method is a key driver of **order reliability**, not revenue
- **Cancellations represent a material and actionable source of revenue leakage**

---

### 6.4. Strategic Implications

- **Diversification opportunity**: Reduce dependency on the Kurta product family
- **Catalog optimization**: Identify and rationalize low-performing SKUs
- **Demand monitoring**: Track fast-moving trends in top-performing products
- **Operational focus**: Improve Merchant fulfillment processes to reduce cancellations
- **Revenue protection**: Prioritize actions that reduce cancellation-related losses
